...
const closeDetail = () => {
  ...
  // Zavoláme reset kamery v komponente mapy
  if (mapRef.value) {
  ...
  <div class="app-container">
    ...
    <Transition name="slide">
      <div v-if="selectedLocation" class="detail-sidebar">
        ...
        <div class="stats">
          <span>Populácia: {{ selectedLocation.stats.pop }}</span>
          <span>Frakcia: {{ selectedLocation.stats.faction }}</span>
        </div>
      </div>
    </Transition>
  </div>
...
<style>
/* Základný reset a štýly sú v style.css */
.app-container {
  position: relative;
  width: 100vw;
  height: 100vh;
