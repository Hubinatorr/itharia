...
const text = 'Snow fell, burying the dead and dammed alike. \n' +
        '\n' +
...
<template>
    <div class="text-white w-full h-full text-center flex flex-col justify-center items-center">
        <div class="lg:mx-auto p-4 lg:w-1/2 space-y-4 text-yellow-100">
            <div class="text-3xl font-semibold text-yellow-200">Flames of Destiny</div>
            <div class="text-2xl font-semibold text-yellow-200">Prologue: Spark</div>
