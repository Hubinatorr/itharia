<template>
    <nav class=" border-stone-200 bg-stone-950 shadow-sm">
        <div class="flex flex-wrap justify-between mx-auto p-2">
            ...
            <button @click="isMobileMenuOpen = !isMobileMenuOpen" type="button"
                    class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-stone-500 rounded-lg md:hidden hover:bg-stone-100 focus:outline-none focus:ring-2 focus:ring-stone-200 text-stone-400 hover:bg-stone-700 focus:ring-stone-600"
            ...
            <div :class="{'hidden': !isMobileMenuOpen, 'block': isMobileMenuOpen}"
                 ...
                 id="navbar-dropdown">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-stone-100 rounded-lg bg-stone-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-stone-800 md:bg-stone-950 border-stone-700">

                    <li>
                        <a href="/"
                           class="text-xl block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 text-white md:text-yellow-200"
                           aria-current="page">
                            Home
                        </a>
                    </li>
                        ...
                        <div v-show="isGamesDropdownOpen"
                            ...
                            <ul class="py-2 text-sm text-stone-400">
                                ...
                                <li><a href="/quests-of-itharia"
                                       class="block px-4 py-2 hover:text-yellow-200 text-xl">Quest
                                    of Itharia</a></li>
                                <li><a href="/cards-of-itharia"
                                       class="block px-4 py-2 hover:text-yellow-200 text-xl">Cards
                                    of Itharia</a></li>
                            </ul>
                        </div>
                    </li>
